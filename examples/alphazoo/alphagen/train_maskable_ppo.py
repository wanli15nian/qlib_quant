...
def main(
    ...
    """
    Train a MaskablePPO model on AlphaGen environment.

    :param seed: random seed
    :param instruments: stock code or "all" for all stocks
    :param target: the target stock price in the future
    :param pool_capacity: the maximum number of alphas in the pool
    :param steps: the number of training steps
    :param GPU: the GPU index to use, -1 for CPU
    """
    ...
    target = Ref(close, -target) / close - 1


    dataset_conf = {
        "class": "StockData",
        "module_path": "examples.alphazoo.alphagen.alphagen_qlib.stock_data",
        "kwargs": {
    ...
    dataset_train_conf = dataset_conf.copy()
    dataset_train_conf['kwargs']['start_time'] = '2016-01-01'
    dataset_train_conf['kwargs']['end_time'] = '2019-12-31'
    data_train = init_instance_by_config(dataset_train_conf)

    dataset_valid_conf = dataset_conf.copy()
    dataset_valid_conf['kwargs']['start_time'] = '2020-01-01'
    dataset_valid_conf['kwargs']['end_time'] = '2020-12-31'
    data_valid = init_instance_by_config(dataset_valid_conf)
    ...
    data_test = init_instance_by_config(dataset_test_conf)
...
if __name__ == '__main__':
    ...
    main(42, 'csi300', pool_capacity = 10, steps = 10000)
